...
var ClaimIndexComponent = /** @class */ (function () {
    function ClaimIndexComponent() {
    }
    ClaimIndexComponent.prototype.ngOnInit = function () {
    };
...
var ColaboraService = /** @class */ (function () {
    function ColaboraService(http) {
        this.http = http;
        this.baseUrl = "http://localhost:3000/colabora";
    }
    ColaboraService.prototype.nuevo = function (values) {
        return this.http.post(this.baseUrl + "/nuevo", values).toPromise();
    };
    ColaboraService.ctorParameters = function () { return [
...
var ColaboraComponent = /** @class */ (function () {
    function ColaboraComponent() {
        this.titulo = "";
    }
    ColaboraComponent.prototype.ngOnInit = function () {
    };
...
var ComparaService = /** @class */ (function () {
    function ComparaService(http) {
        this.http = http;
        this.baseUrl = "http://localhost:3000/compara";
    }
    ComparaService.prototype.comparar = function (values) {
        return this.http.post(this.baseUrl + "/salarios", values).toPromise();
    };
    ComparaService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var ComparaComponent = /** @class */ (function () {
    function ComparaComponent() {
    }
    ComparaComponent.prototype.ngOnInit = function () {
    };
...
var FormcolComponent = /** @class */ (function () {
    function FormcolComponent(colaboraService, router) {
    ...
    FormcolComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    FormcolComponent.prototype.ngOnInit = function () {
    };
    FormcolComponent.ctorParameters = function () { return [
...
var FormcompComponent = /** @class */ (function () {
    function FormcompComponent(comparaService, router) {
    ...
    FormcompComponent.prototype.onSubmit = function () {
        var _this = this;
        this.comparaService.comparar(this.formulario_solicitud.value)
            .then(function (response) {
            _this.salario_medio = response[0][0]['salario_medio'];
            _this.datos_devs = response[1][0];
            _this.datos_totales = response[1];
            if (_this.salario_medio == null) {
                _this.no_results = 'Lo sentimos, no hay resultados para tu búsqueda :\'(';
            }
            else {
                _this.no_results = '';
            }
            ...
            .catch(function (err) {
            _this.no_results = 'Lo sentimos, ocurrió un error enviando el formulario, inténtalo de nuevo más tarde';
        });
    };
    FormcompComponent.prototype.scroll = function (element) {
        element.scrollIntoView();
    };
    FormcompComponent.prototype.ngOnInit = function () {
    };
    FormcompComponent.ctorParameters = function () { return [
...
var GraciasComponent = /** @class */ (function () {
    function GraciasComponent() {
    }
    GraciasComponent.prototype.ngOnInit = function () {
    };
...
var HeroComponent = /** @class */ (function () {
    ...
    HeroComponent.prototype.scroll = function (element) {
        element.scrollIntoView();
    };
...
var MenuComponent = /** @class */ (function () {
    ...
    MenuComponent.prototype.cambiaestado = function () {
...
var TablaresultadosComponent = /** @class */ (function () {
    function TablaresultadosComponent() {
    }
    TablaresultadosComponent.prototype.ngOnInit = function () {
    };
    ...
    return TablaresultadosComponent;
}());
